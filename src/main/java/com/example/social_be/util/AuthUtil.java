...
//refresh token
    ...
    ResponseCookie accessTokenResponseCookie = ResponseCookie.from(accessTokenCookie.getName(),accessTokenCookie.getValue())
                    .sameSite("None")
                    .secure(true)
    ...
    ResponseCookie refreshTokenResponseCookie =  ResponseCookie.from(refreshTokenCookie.getName(),accessTokenCookie.getValue())
                    .sameSite("None")
                    .secure(true)
